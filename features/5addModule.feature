Feature: Add a Module
  ...
  Scenario: Create module
    ...
    And I fill in "name" with "Algorithms and datascructures"
    And I fill in "short_name" with "AD"
    And I fill in "description" with "Learn the essential algorithms"
    And I click on the element with id "professor-0"
    And I click on the element with id "save"
    Then I should see "Learn the essential algorithms"