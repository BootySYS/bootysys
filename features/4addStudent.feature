Feature: Add a student
  ...
  Scenario: Add student
    ...
    And I fill in "first_name" with "Bingo"
    And I fill in "last_name" with "DeGringo"
    And I fill in "email" with "bingodominus.efdegringo@haw-hamburg.de"
    And I fill in "major" with "Computer Science"
    And I fill in "semester" with "1"
    And I click on the element with id "save"
    And the "table" element should contain "Bingo"
    And the "table" element should contain "DeGringo"
    And the "table" element should contain "bingodominus.efdegringo@haw-hamburg.de"
